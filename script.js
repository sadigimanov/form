...
const formInput = (element) => {
    return `
        <input type="text" name="name"  data-text="true" data-min="3" data-message="Zəhmət olmasa adı boş buraxmayın" class="border border-gray-300 h-[40px] w-full rounded-[5px] px-[15px]">
    `
};
